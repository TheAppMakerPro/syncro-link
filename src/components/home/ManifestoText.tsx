...
function RevealSection({ children, className = "", highlight = false }: SectionProps) {
  return (
    <motion.div
      ...
      className={`${highlight ? "text-amber-300/90" : "text-[#f0f0ff]/70"} ${className}`}
    >
      {children}
    </motion.div>
  );
...
export default function ManifestoText() {
  return (
    <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 py-16 space-y-8">
      <RevealSection>
        <p className="text-sm uppercase tracking-[0.3em] text-amber-400/60 text-center mb-8">
          Message to All
        </p>
        <p className="text-lg leading-relaxed">
          ...
          <span className="text-amber-300">It is the instruction set.</span> And so we begin...
        </p>
      </RevealSection>
      ...
      <RevealSection highlight>
        ...
        <p className="text-2xl sm:text-3xl text-center mt-6 font-semibold tracking-wider" style={{ textShadow: "0 0 30px rgba(255,215,0,0.3)" }}>
      ...
      <RevealSection highlight>
        <p className="text-2xl text-center font-semibold tracking-wide" style={{ textShadow: "0 0 30px rgba(255,215,0,0.3)" }}>
      ...
      <RevealSection>
        <h2 className="text-3xl font-bold text-center text-amber-400 tracking-wider mb-6" style={{ textShadow: "0 0 30px rgba(255,215,0,0.3)" }}>
          THE RIGHT LIGHT
        </h2>
        <p className="text-lg leading-relaxed">
      ...
      {/* The 3 Rules */}
      <RevealSection>
        <h2 className="text-2xl font-bold text-center text-[#f0f0ff] tracking-wider mb-8">
          The 3 Rules of the Network
        </h2>
        <div className="space-y-6">
          <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-6">
            <p className="text-amber-400 font-semibold mb-2">1. No Capitalism Whatsoever</p>
            <p className="text-[#f0f0ff]/70 leading-relaxed">
          ...
          <div className="rounded-2xl border border-violet-500/20 bg-violet-500/5 p-6">
            <p className="text-violet-400 font-semibold mb-2">2. Be Nice</p>
            <p className="text-[#f0f0ff]/70 leading-relaxed">No bad actors.</p>
          </div>
          <div className="rounded-2xl border border-cyan-500/20 bg-cyan-500/5 p-6">
            <p className="text-cyan-400 font-semibold mb-2">3. Unite and Enlight</p>
            <p className="text-[#f0f0ff]/70 leading-relaxed">No doom and gloom.</p>
          </div>
        </div>
      </RevealSection>

      <RevealSection>
        <p className="text-xs text-[#8888aa] leading-relaxed text-center">
      ...
      <RevealSection>
        <div className="text-center space-y-6">
          <p className="text-lg leading-relaxed text-[#f0f0ff]/70">
          ...
          <p className="text-xl text-amber-300 font-light" style={{ textShadow: "0 0 20px rgba(255,215,0,0.3)" }}>
            Love, light, peace and ringing ears for All! Let &apos;em ring!
          </p>
          <p className="text-[#8888aa] italic">— Chris</p>
        </div>
      </RevealSection>
      ...
      >
        <a
          href="/registry"
          className="inline-flex items-center justify-center px-10 py-4 rounded-full font-semibold text-white bg-gradient-to-r from-amber-500 to-yellow-400 shadow-lg shadow-amber-500/30 hover:shadow-amber-500/50 transition-all duration-300 hover:scale-105 text-lg"
        >
